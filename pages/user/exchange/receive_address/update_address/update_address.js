...
Page({
  ...
  bindKeyInput1: function(e) {
    // console.log('收货人为', e.detail.value)
    this.setData({
      name: e.detail.value
    })
  },
  ...
  bindKeyInput3: function(e) {
    // console.log('邮件编码为', e.detail.value)
    this.setData({
    ...
    if (that.data.detailAddress == "" || that.data.detailAddress == null) {
      ...
      app.api.updateAddress({
        ...
        .then(res => {
          ...
          wx.navigateTo({
            url: '/pages/user/exchange/receive_address/receive_address?userid=' + app.user.id
          })
        })
    }
  },
    ...
    app.api.selectReceiveAddress({
      ...
      .then(res => {
        that.setData({
          ...
          defaultStatus: res.data.data.defaultStatus,
          regions: [res.data.data.province, res.data.data.city, res.data.data.region]
        })
      })
  },
